...
- ### init:
  ...
  - **Usage**: `java gitlet.Main init` ![](gitlet_gifs/gitlet_init.gif)
- ### status:
  ...
  - **Usage**: `java gitlet.Main status` ![](gitlet_gifs/gitlet_status.gif)
- ### add:
  - **Description**: Stages a file with filename for addition.
  - **Usage**: `java gitlet.Main add <filename>` ![](gitlet_gifs/gitlet_add.gif)
- ### rm:
  ...
  - **Usage**: `java gitlet.Main rm <filename>` ![](gitlet_gifs/gitlet_rm_stage.gif)
- ### commit:
  ...
  - **Usage**: `java gitlet.Main commit <message>` ![](gitlet_gifs/gitlet_commit.gif)
- ### log:
  ...
  - **Usage**: `java gitlet.Main log` <br> ![](gitlet_gifs/gitlet_log.gif)
- ### branch:
  ...
  - **Usage**: `java gitlet.Main branch <branch name>` ![](gitlet_gifs/gitlet_branch.gif)
- ### checkout:
...
- ### find:
  ...
  - **Usage**: `java gitlet.Main find <commit message>` ![](gitlet_gifs/gitlet_find.gif)
- ### rm-branch:
  ...
  - **Usage**: `java gitlet.Main rm-branch <branch name>` ![](gitlet_gifs/gitlet_rmbranch.gif)
